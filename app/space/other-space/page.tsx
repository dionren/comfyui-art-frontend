...
const otherSpaceData = {
  ...
  userSubscription: "regular" as "free" | "regular" | "premium", // 当前用户在此空间的订阅级别
  userJoined: false, // 用户是否已加入此空间
  userLiked: false, // 用户是否已收藏此空间
}
...
export default function OtherSpacePage() {
  ...
  const [isJoined, setIsJoined] = useState(otherSpaceData.userJoined)
  const [isLiked, setIsLiked] = useState(otherSpaceData.userLiked)
    ...
    <div className="min-h-screen pb-8 dark bg-gray-950 text-gray-200">
          ...
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                ...
                >
                  {otherSpaceData.userSubscription === "premium" ? (
                    <Crown className="h-4 w-4 mr-2 text-amber-400" />
                  ) : otherSpaceData.userSubscription === "regular" ? (
              ...
              <TooltipContent>
                <p>查看"{otherSpaceData.name}"空间订阅计划</p>
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
        ...
        >
          ...
          >
            <div className="flex justify-between items-center mb-6">
              <h3 className="text-2xl font-bold text-white">"{otherSpaceData.name}" 空间订阅计划</h3>
              <Button
                variant="ghost"
                size="sm"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-gray-800 rounded-lg p-6 border border-gray-700 relative">
                <div className="text-center mb-4">
                  <h4 className="text-xl font-bold text-white mb-1">免费会员</h4>
                  <div className="flex items-center justify-center">
                    <span className="text-3xl font-bold text-white">¥0</span>
                    <span className="text-gray-400 ml-1">/月</span>
                  </div>
                  <p className="text-gray-400 mt-2">基础功能，体验AI创作</p>
                </div>
                <div className="space-y-3 mb-6">
                  <div className="flex items-center">
                    <Check className="h-5 w-5 text-purple-400 mr-2 flex-shrink-0" />
                    <span className="text-gray-300 text-sm">访问基础工作流</span>
                  </div>
                  <div className="flex items-center">
                    <Check className="h-5 w-5 text-purple-400 mr-2 flex-shrink-0" />
                    <span className="text-gray-300 text-sm">每日有限使用次数</span>
                  </div>
                  <div className="flex items-center">
                    <Check className="h-5 w-5 text-purple-400 mr-2 flex-shrink-0" />
                    <span className="text-gray-300 text-sm">标准分辨率输出</span>
                  </div>
                  <div className="flex items-center">
                    <Check className="h-5 w-5 text-purple-400 mr-2 flex-shrink-0" />
                    <span className="text-gray-300 text-sm">社区支持</span>
                  </div>
                </div>
                <Button className="w-full bg-gray-700 hover:bg-gray-600 text-gray-300" disabled={true}>
                  当前方案
                </Button>
              </div>
              <div className="bg-gray-800 rounded-lg p-6 border border-purple-500 shadow-lg shadow-purple-500/20 relative">
                ...
                <div className="text-center mb-4">
                  <h4 className="text-xl font-bold text-white mb-1">普通会员</h4>
                  <div className="flex items-center justify-center">
                    <span className="text-3xl font-bold text-white">
                      {formatCurrency(otherSpaceData.membershipFee.regular)}
                    </span>
                    <span className="text-gray-400 ml-1">/月</span>
                  </div>
                  <p className="text-gray-400 mt-2">更多功能，提升创作效率</p>
                </div>
                <div className="space-y-3 mb-6">
                  <div className="flex items-center">
                    <Check className="h-5 w-5 text-purple-400 mr-2 flex-shrink-0" />
                    <span className="text-gray-300 text-sm">访问大部分工作流</span>
                  </div>
                  <div className="flex items-center">
                    <Check className="h-5 w-5 text-purple-400 mr-2 flex-shrink-0" />
                    <span className="text-gray-300 text-sm">优先处理队列</span>
                  </div>
                  <div className="flex items-center">
                    <Check className="h-5 w-5 text-purple-400 mr-2 flex-shrink-0" />
                    <span className="text-gray-300 text-sm">高分辨率输出</span>
                  </div>
                  <div className="flex items-center">
                    <Check className="h-5 w-5 text-purple-400 mr-2 flex-shrink-0" />
                    <span className="text-gray-300 text-sm">保存历史记录</span>
                  </div>
                  <div className="flex items-center">
                    <Check className="h-5 w-5 text-purple-400 mr-2 flex-shrink-0" />
                    <span className="text-gray-300 text-sm">技术支持</span>
                  </div>
                </div>
                <Button
                  className={`w-full ${
                  ...
                  disabled={otherSpaceData.userSubscription === "regular"}
                >
                  {otherSpaceData.userSubscription === "regular" ? "当前方案" : "升级"}
                </Button>
              </div>
              <div className="bg-gray-800 rounded-lg p-6 border border-amber-700/50 relative">
                <div className="text-center mb-4">
                  <h4 className="text-xl font-bold text-white mb-1">高级会员</h4>
                  <div className="flex items-center justify-center">
                    <span className="text-3xl font-bold text-white">
                      {formatCurrency(otherSpaceData.membershipFee.premium)}
                    </span>
                    <span className="text-gray-400 ml-1">/月</span>
                  </div>
                  <p className="text-gray-400 mt-2">全部功能，无限创作可能</p>
                </div>
                <div className="space-y-3 mb-6">
                  <div className="flex items-center">
                    <Check className="h-5 w-5 text-purple-400 mr-2 flex-shrink-0" />
                    <span className="text-gray-300 text-sm">访问全部工作流</span>
                  </div>
                  <div className="flex items-center">
                    <Check className="h-5 w-5 text-purple-400 mr-2 flex-shrink-0" />
                    <span className="text-gray-300 text-sm">最高优先级处理</span>
                  </div>
                  <div className="flex items-center">
                    <Check className="h-5 w-5 text-purple-400 mr-2 flex-shrink-0" />
                    <span className="text-gray-300 text-sm">超高分辨率输出</span>
                  </div>
                  <div className="flex items-center">
                    <Check className="h-5 w-5 text-purple-400 mr-2 flex-shrink-0" />
                    <span className="text-gray-300 text-sm">批量处理能力</span>
                  </div>
                  <div className="flex items-center">
                    <Check className="h-5 w-5 text-purple-400 mr-2 flex-shrink-0" />
                  ...
                  <div className="flex items-center">
                    <Check className="h-5 w-5 text-purple-400 mr-2 flex-shrink-0" />
                    <span className="text-gray-300 text-sm">API访问权限</span>
                  </div>
                </div>
                <Button
                  className={`w-full ${
                  ...
                  disabled={otherSpaceData.userSubscription === "premium"}
                >
                  {otherSpaceData.userSubscription === "premium" ? "当前方案" : "升级至高级会员"}
                </Button>
              </div>
            </div>
            ...
            <div className="mt-8 bg-gray-800/50 rounded-lg p-4 border border-gray-700">
              ...
              <ul className="space-y-2 text-sm text-gray-300">
                ...
                <li className="flex items-start">
                  <span className="text-purple-400 mr-2">•</span>
                  <span>此订阅计划仅适用于"{otherSpaceData.name}"空间，每个空间需单独订阅</span>
                </li>
                <li className="flex items-start">
                  <span className="text-purple-400 mr-2">•</span>
      ...
      {showContactModal && (
        ...
        >
          ...
          >
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-xl font-bold text-white">联系创建者</h3>
              <Button
                variant="ghost"
                size="sm"
                className="text-gray-400 hover:text-white"
            ...
            <div className="mb-4">
              <div className="flex items-center space-x-3 mb-4">
                <Avatar className="h-10 w-10">
                  <AvatarImage
                    src={otherSpaceData.author.avatar || "/placeholder.svg"}
                    alt={otherSpaceData.author.name}
                  />
                  <AvatarFallback className="bg-gray-700 text-gray-200">
                    {otherSpaceData.author.name.charAt(0)}
                  </AvatarFallback>
                </Avatar>
                <div>
                  <p className="font-medium text-white">{otherSpaceData.author.name}</p>
                  <p className="text-xs text-gray-400">空间创建者</p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Input placeholder="请输入消息主题" className="bg-gray-800 border-gray-700 text-gray-200" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-400 mb-1">消息内容</label>
                  <textarea
                    rows={4}
          ...
          <div className="container mx-auto px-4 h-full flex flex-col justify-end pb-8">
            <div className="flex flex-col">
              <div className="flex items-center mb-3">
                <h1 className="text-3xl font-bold text-white drop-shadow-md">{otherSpaceData.name}</h1>
                <Badge variant="outline" className="ml-4 bg-blue-900/70 backdrop-blur-sm border-blue-700 text-blue-300">
                  {otherSpaceData.category}
                </Badge>
              </div>
              <p className="text-gray-300/90 drop-shadow-md max-w-2xl">{otherSpaceData.description}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="bg-gray-900/60 backdrop-blur-sm rounded-xl p-4 -mt-6 mb-8 border border-gray-800/50 shadow-xl">
          <div className="flex flex-wrap items-center gap-4">
            ...
            >
              ...
              {otherSpaceData.stats.totalRuns} 使用量
            </Badge>
            <Badge
              variant="outline"
              className="text-sm py-1.5 bg-gray-800/50 text-gray-300 border-gray-700 hover:bg-gray-800"
            >
              ...
              {formatNumber(otherSpaceData.visits)} 访问量
            </Badge>
            <Badge
              variant="outline"
              className="text-sm py-1.5 bg-gray-800/50 text-gray-300 border-gray-700 hover:bg-gray-800"
            >
              ...
              更新于 {formatDate(otherSpaceData.updatedAt)}
            </Badge>
            <div className="ml-auto flex gap-2">
              <Button
                ...
                className={`${
                  isLiked
                    ? "bg-pink-900/30 border-pink-700 text-pink-400 hover:bg-pink-900/50"
                    : "bg-gray-800 border-gray-700 text-gray-200 hover:bg-gray-700"
                }`}
                onClick={handleLikeSpace}
              >
                <Heart className={`h-4 w-4 mr-2 ${isLiked ? "fill-pink-400" : ""}`} />
                {isLiked ? "已收藏" : "收藏空间"}
              </Button>
              <Button
                variant="outline"
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
              <div>
                <h2 className="text-xl font-bold text-white mb-2 flex items-center">
                  ...
                  升级您在"{otherSpaceData.name}"的创作体验
                </h2>
                <p className="text-gray-300 max-w-2xl">
                  解锁此空间的更多高级功能，提升创作效率。选择适合您的订阅计划，享受更多专属特权。
                </p>
              </div>
              <Button
            ...
            <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="bg-gray-800/50 rounded-lg p-4 border border-blue-700/30 flex items-center">
                ...
                <div className="text-blue-400 font-medium">
                  {formatCurrency(otherSpaceData.membershipFee.regular)}/月
                </div>
              </div>
              <div className="bg-gray-800/50 rounded-lg p-4 border border-amber-700/30 flex items-center">
                ...
                <div className="text-amber-400 font-medium">
                  {formatCurrency(otherSpaceData.membershipFee.premium)}/月
                </div>
              </div>
            </div>
          </div>
              ...
              >
                ...
                <CardFooter className="flex justify-between pt-2 border-t border-gray-800">
                  <div className="flex items-center text-xs text-gray-500">
                    ...
                    <span>{app.stats.favorites} 收藏</span>
                  </div>
                  {!userCanAccess && app.accessType !== "pay-per-use" ? (
                    <Button
                      size="sm"
        ...
        {/* 空间创建者信息 */}
        <div className="mt-12 bg-gray-900/60 backdrop-blur-sm rounded-xl p-6 border border-gray-800/50 shadow-xl">
            ...
            <div className="flex items-center gap-4">
              <Avatar className="h-16 w-16">
                <AvatarImage
                  ...
                  alt={otherSpaceData.author.name}
                />
                <AvatarFallback className="bg-gray-700 text-gray-200 text-xl">
                  {otherSpaceData.author.name.charAt(0)}
                </AvatarFallback>
              </Avatar>
              <div>
                <h3 className="text-xl font-bold text-white">{otherSpaceData.author.name}</h3>
                <p className="text-sm text-gray-400">空间创建者</p>
                <p className="text-sm text-gray-400">创建于 {formatDate(otherSpaceData.createdAt)}</p>
              </div>
            </div>
            <div className="flex-1">
              <p className="text-gray-300">
                {otherSpaceData.author.name}
                是一位专业摄影师，致力于将AI技术应用于摄影创作领域。创建此空间旨在帮助摄影师们提高工作效率，探索AI辅助创作的无限可能。
              </p>
            </div>
            <div>
              <Button
